...
#PS: consider a finer analysis on image spots using CellProfiler
...
image<-Read10X_Image('filepath/outs/spatial/')
Spatial<-Load10X_Spatial('filepath/outs/', image=image)
